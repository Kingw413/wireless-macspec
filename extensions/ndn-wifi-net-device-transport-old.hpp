...
#ifndef NDN_WIFI_NET_DEVICE_TRANSPORT_OLD_HPP
#define NDN_WIFI_NET_DEVICE_TRANSPORT_OLD_HPP
 ...
 */
class WifiNetDeviceTransportOld : public nfd::face::Transport
{
public:
  WifiNetDeviceTransportOld(Ptr<Node> node, const Ptr<WifiNetDevice>& netDevice,

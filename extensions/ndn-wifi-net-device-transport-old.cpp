...
NS_LOG_COMPONENT_DEFINE("ndn.WifiNetDeviceTransportOldOld");

namespace ns3 {
namespace ndn {

WifiNetDeviceTransportOld::WifiNetDeviceTransportOld(
    ...
    m_node->RegisterProtocolHandler(
        MakeCallback(&WifiNetDeviceTransportOld::receiveFromNetDevice, this),
        L3Protocol::ETHERNET_FRAME_TYPE, m_netDevice,
        true /*promiscuous mode*/);
}

WifiNetDeviceTransportOld::~WifiNetDeviceTransportOld() { NS_LOG_FUNCTION_NOARGS(); }

ssize_t WifiNetDeviceTransportOld::getSendQueueLength() {
    PointerValue txQueueAttribute;
    if (m_netDevice->GetAttributeFailSafe("TxQueue", txQueueAttribute)) {
        Ptr<ns3::QueueBase> txQueue = txQueueAttribute.Get<ns3::QueueBase>();
...
void WifiNetDeviceTransportOld::doClose() {
...
void WifiNetDeviceTransportOld::doSend(const Block& packet,
...
// callback
void WifiNetDeviceTransportOld::receiveFromNetDevice(
...
Ptr<NetDevice> WifiNetDeviceTransportOld::GetNetDevice() const {
    return m_netDevice;
}
